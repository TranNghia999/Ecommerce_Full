                            ...
                            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 font-[500]">
                                        ...
                                        <td className="px-6 py-4 font-[500]">
                                            <span className='text-primary'>6849aec8228db479bb5bb849</span> 
                                        </td>
                                        <td className="px-6 py-4 font-[500]">
                                            <span className='text-primary whitespace-nowrap'>CASH ON DELIVERY</span> 
                                        </td>

                                        <td className="px-6 py-4 font-[500] whitespace-nowrap"> Sophia-Pham</td>
                                        <td className="px-6 py-4 font-[500]"> 9198724897 </td>

                                        <td className="px-6 py-4 font-[500]">
                                            <span className='block w-[400px]'>Tam Sơn, Thập Thất, Sơn Thủy</span>  
                                        </td>

                                        <td className="px-6 py-4 font-[500]"> 3989047 </td>
                                        <td className="px-6 py-4 font-[500]">  3998</td>
                                        <td className="px-6 py-4 font-[500]">  tranhoakelvin@gmail.com  </td>

                                        <td className="px-6 py-4 font-[500]">
                                            <span className='text-primary'>683eb6b8228db479bb4fd37c</span>  
                                        </td>

                                        <td className="px-6 py-4 font-[500]">  <Badge status="confirm"/> </td>
                                        <td className="px-6 py-4 font-[500] whitespace-nowrap"> 2025-06-11 </td>
                                    </tr>
                                    {
                                                ...
                                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    ...
                                                    <tbody>
                                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 font-[500]">
                                                            ...
                                                            <td className="px-6 py-4 font-[500]">
                                                                <span className='text-gray-600'>6849ae91228db479bb5bb7ca</span> 
                                                            </td>
                                                            <td className="px-6 py-4 font-[500]">
                                                            ...
                                                            <td className="px-6 py-4 font-[500] ">
                                                                <img src='https://serviceapi.spicezgold.com/download/1742462729828_zoom_0-1673275594.webp'
