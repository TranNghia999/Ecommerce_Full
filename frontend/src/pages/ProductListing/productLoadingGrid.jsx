...
const ProductLoaingGrid = (props) => {
  if (props?.view !== "grid") return null;
  ...
  return (
    <>
      {skeletons.map((_, i) => (
        <div key={i} className="col w-[100%] h-[250px]">
          <div className="flex items-center mb-3 justify-center w-full h-48 bg-gray-300 rounded dark:bg-gray-700">
            <svg
...
export default ProductLoaingGrid;
