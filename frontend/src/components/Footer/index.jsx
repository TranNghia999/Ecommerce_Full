...
// nút này sẽ được sử dụng để tạo nút trong phần footer - input
import FormControlLabel from '@mui/material/FormControlLabel';
import Checkbox from '@mui/material/Checkbox';

// nút cuối của trang, thông tin bản quyền, chính sách bảo mật, v.v.
                ...
                <div className='part2 w-[35%] flex pl-8 flex-col pr-8'>
                          ...
                          <p className='text-[13px]'>Subscribe to our latest newsletter to get news about special discounts.</p>
                            ...
                            <from className='mt-5'>
                                ...
                                pl-4 pr-4 rounded-sm mb-4 focus:border-[rgba(0,0,0,0.3)]' 
